...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Values does not contain a decimal point
...
//This function updates the calculator screen with the contents os Display_Value
